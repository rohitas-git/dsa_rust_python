...
# if values of keys are in [0+k : 1000 + k]
# for [0:1000] -> k =0
# for [1000:2000] -> k=1000

# --------------------------------------------------------
# initialize a boolean array
directAddressTable = [False]*(1000)

def search(num, k):
    return directAddressTable[num-k]

def insert(num,k):
    directAddressTable[num-k] = True

def delete(num,k):
    directAddressTable[num,k] = False
...
# ! Problem with Direct Address Table: It can't handle
